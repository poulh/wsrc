...
//todo: it should be an option to use the random header image or the selected one.
$ribbon_background = get_random_header_image(); // todo: this method was also called in header but i keep getting back same image. why??!!?!
//$header_images = get_uploaded_header_images();
//shuffle($header_images);
//$ribbon_background = $header_images[0];
