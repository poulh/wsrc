...
if ( ! empty( $parallax_one_happy_customers_title ) || ! empty( $parallax_one_happy_customers_subtitle ) || ! parallax_one_general_repeater_is_empty( $parallax_one_testimonials_content ) ) { ?>
			...
			<div class="container">
				...
				$parallax_one_testimonials_content_decoded = json_decode( $parallax_one_testimonials_content );
						...
						foreach ( $parallax_one_testimonials_content_decoded as $parallax_one_testimonial ) {
							$icon            = ! empty( $parallax_one_testimonial->icon_value ) ? apply_filters( 'parallax_one_translate_single_string', $parallax_one_testimonial->icon_value, 'Testimonials section' ) : '';
							...
							$section_is_empty = empty( $icon ) && empty( $title ) && empty( $subtitle ) && empty( $text );
					      ...
					      <div style="display:flex; width:100%; padding-bottom:20px;">
							<div style="display:block-inline; margin-right:20px;">
								<?php if( ! empty($icon)) { ?>
								<div class="colored-text" style="border:solid; padding:21px;border-width:1px;border-radius:50%;border-color:currentcolor;">
									<div style="font-size:26px;height:26px;width:26px;">
	...
	<div style="display:inline-block;">
	  <div style="text-align:left;"><?php echo html_entity_decode($text) ?></div>
	</div>
      </div>
