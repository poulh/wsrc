...
if ( 'posts' == get_option( 'show_on_front' ) ) {
	...
	<?php
		...
		/* Original Sections: $sections_array = apply_filters( 'parallax_one_plus_sections_filter', array( 'sections/parallax_one_logos_section', 'sections/parallax_one_our_services_section', 'sections/parallax_one_our_story_section', 'sections/parallax_one_our_team_section', 'sections/parallax_one_happy_customers_section', 'sections/parallax_one_ribbon_section', 'sections/parallax_one_latest_news_section', 'sections/parallax_one_contact_info_section', 'sections/parallax_one_map_section' ) ); */
	
		$sections_array = apply_filters( 'parallax_one_plus_sections_filter', array( 'sections/parallax_one_latest_news_section', 
'sections/parallax_one_ribbon_section',
'sections/parallax_one_contact_info_section',																				'sections/parallax_one_our_services_section',	
'sections/parallax_one_icon_list_section',  
