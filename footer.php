...
<footer itemscope itemtype="http://schema.org/WPFooter" id="footer" role="contentinfo" class = "footer grey-bg">
	...
	?>
		...
		<?php echo apply_filters( 'parallax_one_plus_footer_text_filter', '<div class="powered-by">' . esc_html__( 'Site by ', 'parallax-one' ) . '<a class="" href="http://www.asquaredsoftware.com/" target="_blank" rel="nofollow">' . esc_html__( 'A-Squared Software', 'parallax-one' ) . '</a></div>' ); ?>
	</div><!-- container -->
</footer>
