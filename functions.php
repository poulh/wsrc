...
function get_header_image2() {
	return 'http://westsiderepublicanclub.asquaredsoftware.com/wp-content/uploads/2018/07/architecture-building-buildings-861609.jpg';
...
function parallax_one_php_style() {
	...
	if ( ( empty( $parallax_one_enable_move ) || ! $parallax_one_enable_move ) && 'posts' == get_option( 'show_on_front' ) && is_front_page() ) {
		$parallax_one_header_image = get_random_header_image();
		...
		<main id="main" class="site-main" role="main">
			...
			<section class="error-404 not-found">
				<header class="page-header">
					<h2 class="page-title"><?php esc_html_e( 'An Elephant Never Forgets!', 'parallax-one' ); ?></h2>
				</header><!-- .page-header -->

				<div class="page-content">
					<p><?php esc_html_e( 'But occasionally they go to the wrong webpage... Maybe try searching below?', 'parallax-one' ); ?></p>
					<p>
						<img src="/wp-content/uploads/2018/07/lost-little-elephant-404.jpg" alt=""/>
					</p>
					<?php get_search_form(); ?>
				</div><!-- .page-content -->
			</section><!-- .error-404 -->
